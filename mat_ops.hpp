...
namespace mat
{
    ...
    template <Matrix M, Matrix M2>
    requires Addable<typename M::type, typename M2::type>
    constexpr void AddMut(M& a, const M2& b) { OperationMut(a, b, [](copy_fast_cv_t<typename M::type> a, copy_fast_cv_t<typename M::type> b){ return a+b; }); }
    ...
    template <Matrix M, typename T = typename M::type>
    requires Addable<typename M::type, T>
    constexpr void ScalarAddMut(M& mat, copy_fast_cv_t<T> v)  noexcept { ScalarOperationMut(mat, v, [](copy_fast_cv_t<typename M::type> a, copy_fast_cv_t<typename M::type> b){ return a+b; }); }
    ...
    template <Matrix M, Matrix M2>
    requires Subtractable<typename M::type, typename M2::type>
    constexpr void SubMut(M& a, const M2& b) { OperationMut(a, b, [](copy_fast_cv_t<typename M::type> a, copy_fast_cv_t<typename M::type> b){ return a-b; }); }
    template <Matrix M, typename T = typename M::type>
    ...
    template <Matrix M, typename T = typename M::type>
    requires Subtractable<typename M::type, T>
    constexpr void ScalarSubMut(M& mat, copy_fast_cv_t<T> v)  noexcept { ScalarOperationMut(mat, v, [](copy_fast_cv_t<typename M::type> a, copy_fast_cv_t<typename M::type> b){ return a-b; }); }
    ...
    template <Matrix M, Matrix M2>
    requires Multipliable<typename M::type, typename M2::type>
    constexpr void MulMut(M& a, const M2& b) { OperationMut(a, b, [](copy_fast_cv_t<typename M::type> a, copy_fast_cv_t<typename M::type> b){ return a*b; }); }
    template <Matrix M, typename T = typename M::type>
    ...
    template <Matrix M, typename T = typename M::type>
    requires Multipliable<typename M::type, T>
    constexpr void ScalarMulMut(M& mat, copy_fast_cv_t<T> v)  noexcept { ScalarOperationMut(mat, v, [](copy_fast_cv_t<typename M::type> a, copy_fast_cv_t<typename M::type> b){ return a*b; }); }
    ...
    template <Matrix M, Matrix M2>
    requires Divideable<typename M::type, typename M2::type>
    constexpr void DivMut(M& a, const M2& b) { OperationMut(a, b, [](copy_fast_cv_t<typename M::type> a, copy_fast_cv_t<typename M::type> b){ return a/b; }); }
    template <Matrix M, typename T = typename M::type>
    ...
    template <Matrix M, typename T = typename M::type>
    requires Divideable<typename M::type, T>
    constexpr void ScalarDivMut(M& mat, copy_fast_cv_t<T> v)  noexcept { ScalarOperationMut(mat, v, [](copy_fast_cv_t<typename M::type> a, copy_fast_cv_t<typename M::type> b){ return a/b; }); }
};
